...
16:find_get_folios_range_tag_for_file_area
...
void replace_page_cache_folio_for_file_area(struct folio *old, struct folio *new)
{
	...
	void (*freepage)(struct folio *) = mapping->a_ops->free_folio;
...
unsigned find_get_folios_range_tag_for_file_area(struct address_space *mapping, pgoff_t *start,
...
EXPORT_SYMBOL(find_get_folios_range_tag_for_file_area);
